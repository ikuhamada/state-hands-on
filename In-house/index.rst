...
Welcome to the STATE hands-on tutorial. In the following, how to run the STATE examples for this hands on is desdribed.  A documentation of the STATE code can be found `here <https://state-doc.readthedocs.io>`_.

Getting started
===============

First of all, we log in to the cluster system (smith).

.. code:: bash

  $ ssh -Y [user_name]@133.1.116.161

or

.. code:: bash

  $ ssh -Y -l [user_name] 133.1.116.161
...
See also `my github page <https://github.com/ikuhamada/state-setup/tree/in-house>`_.
