...
=======================
Beginner course @ CMD42
=======================

Welcome to the STATE hands-on tutorial at CMD42. In the following, how to run the STATE examples for this hands on is desdribed.  A documentation of the STATE code can be found `here <https://state-doc.readthedocs.io>`_.
