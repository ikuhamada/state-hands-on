...
=======================
Beginner course @ CMD46
=======================

Welcome to the STATE hands-on tutorial at CMD46. In the following, how to run the STATE examples for this hands on is desdribed.  A documentation of the STATE code can be found `here <https://state-doc.readthedocs.io>`_.
