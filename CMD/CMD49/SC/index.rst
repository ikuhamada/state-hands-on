...
============================
Supercomputer course @ CMD49
============================

Welcome to the STATE hands-on tutorial at CMD49. In the following, how to run the STATE examples for this hands on is desdribed.  A documentation of the STATE code can be found `here <https://state-doc.readthedocs.io>`_.
...
A short description on the available queues and job script can be found :doc:`here <ohtaka>`, and that on the SLURM commands can be found :doc:`here <slurm>`.
